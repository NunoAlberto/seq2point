...
#python test_main.py --appliance_name microwave --input_window_length 29 --crop -1 --batch_size 64 --test_directory microwaveData/microwave_test_.csv
#python test_main.py --appliance_name fridge --input_window_length 495 --crop -1 --batch_size 64 --test_directory fridgeData/fridge_test_.csv
