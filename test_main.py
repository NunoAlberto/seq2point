...
#python test_main.py --appliance_name dishwasher --input_window_length 1537 --crop -1 --batch_size 64 --test_directory dishwasherData/dishwasher_test_.csv
#python test_main.py --appliance_name washingmachine --input_window_length 2303 --crop -1 --batch_size 64 --test_directory washingmachineData/washingmachine_test_.csv
